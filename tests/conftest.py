...
from parking_api.main.app import create_app, db as _db
from parking_api.main.models import Parking, Client, ClientParking
...
def app():
    ...
    with _app.app_context():
        ...
        client = Client(id=100,
                        ...
                        car_number='L666XP')
        parking = Parking(address="address2",
                          opened=True,
                          count_available_places=98,
                          count_places=100)
        client_parking = ClientParking(client_id=100,
                                       parking_id=1,
